...
/* Design Attribute */
	...
	public AppDTO addDesignAttribute(AppDTO appDTO) {
			...
			designAttributeDao.addDesignAttribute(designAttribute);
	...
	public DesignAttribute getDesignAttributeById(int id) {
		DesignAttribute designAttribute=(DesignAttribute)designAttributeDao.
	...
	public AppDTO listAllDesignAttributes(AppDTO appDTO) {
		...
		appDTO=designAttributeDao.listAllDesignAttributes(appDTO);
		return appDTO;
	}
	...
	public AppDTO updateDesignAttribute(AppDTO appDTO) {
		...
		designAttributeDao.updateDesignAttribute(designAttribute);
	...
	public AppDTO deleteDesignAttribute(AppDTO appDTO) {
		...
		try
		{
			...
			designAttributeDao.deleteDesignAttribute(deleteDesignAttribute);
	...
	{
		Collection activeDesignAttrColl=designAttributeDao.findListByCondition(DesignAttribute.class, 
	...
	public Collection getDesignAttributeListByKey(String likeKey)
	{
		...
		designAttrList=designAttributeDao
...
/* design attribute specification*/
	...
	public AppDTO addDesignAttributeSpecification(AppDTO appDTO) {
		try{
			...
			DesignAttribute designAttr=(DesignAttribute)designAttributeDao.
			findObjectByCondition
			(DesignAttribute.class,new String[] 
			{"id"},
		...
		for(int i=0;i<count;i++)
		{
			...
			designAttributeDao.addDesignAttributeSpecification(designAttrSpec);
	...
	{
		appDTO=designAttributeDao.listAllDesignAttrSpec(appDTO);
		return appDTO;
	...
	public Collection getDesignAttrSpecByDesignAttrId(int designAttrId) {
		Collection designAtributeList=designAttributeDao.
		findListByCondition
	...
	public AppDTO updateDesignAttributeSpecification(AppDTO appDTO) {
		try{
			...
			Collection designAtributeSpecList=designAttributeDao.
			findListByCondition
			(DesignAttributeSpecification.class,new String[] 
			{"designAttribute.id"},
			new Object[] {designAttrId});
